...
def template_2input_1sink():
    ...
    m.add_road(1, 3, dt=1, speed_limit=25, length=200, lanes=2, num_cars=0)
    m.add_road(1, 4, dt=1, speed_limit=25, length=200, lanes=1, num_cars=0)
    m.add_road(3, 4, dt=1, speed_limit=25, length=200, lanes=1, num_cars=0)
    m.add_road(2, 4, dt=1, speed_limit=25, length=200, lanes=1, num_cars=0)
    m.add_road(4, "ralphs", dt=1, speed_limit=25, length=100, lanes=1, num_cars=0)
